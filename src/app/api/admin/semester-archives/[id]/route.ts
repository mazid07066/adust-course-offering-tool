...
export async function GET(
  ...
  try {
    ...
    const archive = await getSemesterArchiveById(archiveId);
    ...
    console.error("Semester archive detail error:", error);
    ...
    return NextResponse.json(
      {
        ...
        error:
          error instanceof Error
            ? error.message
            : "Failed to load semester archive.",
      },
      {
        status,
      }
