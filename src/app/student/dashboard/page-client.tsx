      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <div className="rounded-3xl bg-slate-950 p-6 text-white shadow-sm">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-300">
            S1 preview dashboard for student identity and academic profile. Registration, billing, attendance, grades, admit cards, and results will be activated in later ERP phases.
          </p>
        </div>
